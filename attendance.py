...
class Attendance:
	def __init__(self, root):
		...
		self.var_atten_univ_roll=StringVar()
	...
	#First image section======	
		img=Image.open(r"collage imgs\group.jpg")
    ...
    #second image section======
		...
		img_left=Image.open(r"collage imgs\group cls 02.jpg")
		...
		#Reg
		regLabel=Label(left_inside_frame,text="Univ_roll:",font=("times new roman",11,"bold"),bg="white")
		regLabel.grid(row=0,column=2,padx=4,pady=8,sticky=W)

		atten_reg=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_univ_roll,font=("times new roman",12,"bold"))
		...
		self.AttendanceReportTable=ttk.Treeview(table_frame,column=("id","univ_roll","name","department","time","date","attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
		...
		self.AttendanceReportTable.heading("univ_roll",text="University_roll")
		...
		self.AttendanceReportTable.column("univ_roll",width=100)
	...
	def get_cursor(self, event=""):
		...
		self.var_atten_univ_roll.set(rows[1])

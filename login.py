...
class Login_window(object):
	...
	def __init__(self, root):
		...
		#Image
		self.bg=ImageTk.PhotoImage(file=r"collage imgs\LoginImg.jpg")
		...
		img1=Image.open(r"collage imgs\loginIcon.png")
		...
		#=======Icon Images=====
		img2=Image.open(r"collage imgs\customerUser.png")
		...
		#======Password Icon=====
		img3=Image.open(r"collage imgs\passwordIc.png")
	...
	def login(self):
		...
		elif self.txtuser.get()=="arun" and self.txtpass.get()=="123":
...
class Register:
	def __init__(self, root):
		...
		#=======Bg Image====
		self.bg=ImageTk.PhotoImage(file=r"collage imgs\background.jpg")

		lbl_bg=Label(self.root,image=self.bg)
		lbl_bg.place(x=0,y=0,relwidth=1,relheight=1) 

		#====left image=====
		self.bg1=ImageTk.PhotoImage(file=r"collage imgs\regLeft.jpg")
		...
		#=============Buttons============
		img=Image.open(r"collage imgs\RegR.jpg")
		...
		#Login Button
		img1=Image.open(r"collage imgs\loginR.png")
...
class Face_Recognition_System:
	...
	#First image section======	
		img=Image.open(r"collage imgs\varsity.jpg")
	#LANCOZ converts high level pic to low level	
	...
	#student button====
		img4=Image.open(r"collage imgs\student.jpg")
	...
	#face detection button====
		img5=Image.open(r"collage imgs\face_detector1.jpg")
	...
	#Attendance detection button====
		img6=Image.open(r"collage imgs\smart-attendance.jpg")
	...
	#Chat button====
		img7=Image.open(r"collage imgs\chatIcon.jpeg")
	...
	#Train button====
		img8=Image.open(r"collage imgs\train_data.jpg")
	...
	#Photos button====
		img9=Image.open(r"collage imgs\photo.jpg")
	...
	#Developer button====
		img10=Image.open(r"collage imgs\dev.jpg")
	...
	#Exit button====
		img11=Image.open(r"collage imgs\exit.jpg")
